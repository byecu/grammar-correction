...
def make_demo(fn: Callable, quantized: bool):
    ...
    with gr.Blocks() as demo:
        ...
        with gr.Row():
            ...
            with gr.Column():
                output_text = gr.Textbox(label="Correction", interactive=True, show_copy_button=True)
                correction_time = gr.Textbox(label="Time (seconds)", interactive=True)
        with gr.Row():
        ...
        with gr.Row():
            ...
            button.click(
                ...
                inputs=[input_text, gr.Number(quantized, visible=True)],
